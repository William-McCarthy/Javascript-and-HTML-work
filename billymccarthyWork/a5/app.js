...
document.addEventListener("DOMContentLoaded", function(){
	new Vue({
			...
			template: `<div id="app">
				...
				<div id="controls">
					<div>
						<button @click="handleInput('walk')">Walk Dog</button>
						<button @click="handleInput('Pet')">Pet Dog</button>
						<button @click="handleInput('trick')">Teach a Trick</button>
						<button @click="handleInput('treat')">Give treat</button>
					</div>
