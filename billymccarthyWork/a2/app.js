...
function setupDrawing0() {
  ...
  function draw(p) {
    ...
    for (var i = 0; i < count; i++) {
      ...
      let y = (.5 + .5 * Math.cos(t * 0.5 + i * 1)) * p.height
      ...
      // let y = pct*HEIGHT
      let x = (.5 + .5 * Math.sin(t * 1 + i * 1)) * p.width
...
function setupDrawing1() {
  ...
  function draw(p) {
    ...
    let bounceWidth = 10
    let bounceFreq = 30
    let bouncex = Math.sin(loopPct * bounceFreq) * bounceWidth

    p.circle(150+bouncex,2 * x2+300, 5)
    p.circle(150+bouncex,2 * x, 5)
    ...
    p.circle(x2+ 300, 30 * noiseY + 10, 5)
    p.circle(x2+ 300, 90 * noiseY + 10, 5)
    p.circle(x2+ 300, 150 * noiseY + 10, 5)

    // add 2 more in the exact oposite way
    ...
    p.circle(x2+300, 30 * noiseY2 + 120, 5)
    p.circle(x2+300, 90 * noiseY2 + 120, 5)
    p.circle(x2+300, 150 * noiseY2 + 120, 5)
    ...
    p.circle(x2+300, bounceY + 220, 5)
    p.circle(x2+300, -Math.abs(bounceY) + 290, 5)
...
function setupDrawing3() {
  ...
  function draw(p) {
    ...
    for (var i = 0; i < sides; i++) {
      ...
      for (var k = 0; k < 4; k++){
        p.fill(0, 100, 100)
        let my2 = (.5 + .5 * Math.sin(t * 0.5 + i * 1)) *p.height

        let myx = 400 * p.noise(t + 500, j * .1) - 80
        let myy = 400 * p.noise(t + 500, j * .1) - 80
        let newhue = 360 * i / sides
        p.fill(newhue, 100, 90)
        p.circle(myx, my2,10 ,10)
